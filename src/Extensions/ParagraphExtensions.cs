...
public static class ParagraphExtensions
{
    ...
    /// <returns></returns>
    public static Paragraph WithBorder(this Paragraph paragraph, ParagraphBorderType type, 
        BorderStyle style, Color color, double? spacing = 1, double size = 2, bool shadow = false)
    {
        if (paragraph == null) throw new ArgumentNullException(nameof(paragraph));
    ...
    /// <param name="shadow"></param>
    /// <returns></returns>
    public static Paragraph WithBorders(this Paragraph paragraph, 
        BorderStyle style, Color color, double? spacing = 1, double size = 2, bool shadow = false)
    {
        if (paragraph == null) throw new ArgumentNullException(nameof(paragraph));
